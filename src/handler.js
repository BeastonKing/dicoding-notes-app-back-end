...
const addNoteHandler = (request, h) => {
    ...
    const isSuccessful = notes.filter((note) => note.id === id).length > 0;
...
module.exports = { addNoteHandler, getAllNotesHandler, getNoteByIdHandler, editNoteByIdHandler, deleteNodeByIdHandler };